...
class UNet2d(nn.Module):
    def __init__(self, in_cha=3, out_cha=3, features=[32,32,32], bilinear=False, first = False, final = False):
        super().__init__()
...
class uC_skip(nn.Module):
    def __init__(self,in_channels,out_channels,channels,bilinear,first,final):
        super().__init__()
...
class uC_3DUXNET(nn.Module):
    ...
    def __init__(
        ...
        self.encoder1 = uC_skip(self.in_chans,self.feat_size[0],[self.feat_size[0],self.feat_size[1],self.feat_size[2],self.feat_size[3]],False,True,True)
        self.encoder2 = uC_skip(self.feat_size[0], self.feat_size[1],[self.feat_size[0],self.feat_size[1],self.feat_size[2],self.feat_size[3]],False,False,True)
        self.encoder3 = uC_skip(self.feat_size[1], self.feat_size[2],[self.feat_size[1],self.feat_size[2],self.feat_size[3]],False,False,True)
        self.encoder4 = uC_skip(self.feat_size[2], self.feat_size[3],[self.feat_size[2],self.feat_size[3]],False,False,True)
