...
class uC_SwinUNETR(nn.Module):
    ...
    def __init__(
        ...
        self.encoder1 = uC_skip(in_channels,feature_size,[feature_size,feature_size*2,feature_size*4,feature_size*8],False,True,True)
        self.encoder2 = uC_skip(feature_size,feature_size,[feature_size,feature_size*2,feature_size*4,feature_size*8],False,False,True)
        self.encoder3 = uC_skip(feature_size*2,feature_size*2,[feature_size*2,feature_size*4,feature_size*8],False,False,True)
        self.encoder4 = uC_skip(feature_size*4,feature_size*4,[feature_size*4,feature_size*8],False,False,True)
