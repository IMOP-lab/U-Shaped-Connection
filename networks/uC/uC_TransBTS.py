...
class TransformerBTS(nn.Module):
    def __init__(
        ...
        self.unet1 =  uC_skip(16,16,[16,32,64,128,256],False, False, False)
        self.unet2 =  uC_skip(32,32,[32,64,128,256],False, False, False)
        self.unet3 =  uC_skip(64,64,[64,128,256],False, False, False)
    ...
    def encode(self, x):
        ...
        # print("1",x1_1.shape,x2_1.shape,x3_1.shape)
        x1_1 = self.unet1(x1_1)
        x2_1 = self.unet2(x2_1)
        x3_1 = self.unet3(x3_1)
        # print(x1_1.shape,x2_1.shape,x3_1.shape)
